...
metadata {
	definition (name: "GE Motion Switch 26931", namespace: "baurandr", author: "Andrew Baur") {
...
def Up() {
//up press sent from app
	sendEvent(name: "app button", value: "pushed", data: [buttonNumber: "1"], descriptionText: "On/Up (button 1) on $device.displayName was pushed in app", isStateChange: true, type: "digital")
    on()
}

def Down() {
//up press sent from app
	sendEvent(name: "app button", value: "pushed", data: [buttonNumber: "2"], descriptionText: "Off/Down (button 2) on $device.displayName was pushed in app", isStateChange: true, type: "digital")
    off()
}
