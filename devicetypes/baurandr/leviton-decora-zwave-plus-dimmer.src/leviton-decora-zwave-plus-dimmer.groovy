 ...
 */
metadata {
    definition (name: "Leviton Decora Z-Wave Plus Dimmer", namespace: "baurandr", author: "Andrew Baur", ocfDeviceType: "oic.d.light") {
        capability "Actuator"
    ...
    tiles(scale: 2) {
		...
		standardTile("flash", "device.switch", width: 2, height: 2, inactiveLabel: false, decoration: "flat") {
        ...
        main("switch")
        details(["switch", "low", "medium", "high", "flash", "level", "refresh"])
    }
...
def on() {
log.debug "Switch on section of code"
//setLevel(100)
    delayBetween([
...
def off() {
log.debug "Switch off section of code"
//setLevel(0)
    delayBetween([
